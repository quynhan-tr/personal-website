...
export default function ProjectsSection() {
  return (
    <section id="projects" className="max-w-7xl mx-auto px-4 lg:px-8 pt-16 md:pt-20 lg:pt-33 pb-4 md:pb-8 flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
      {/* Heading */}
